...
Inference: t-test to compares means
...
```
  Graphical summary appears that line position players does less pushups in 2 minutes than skilled position players.
...
summary(players)
```
Nummerical summary shows that weight and position shows a signifcant difference in the pushups done by line and skill players. And there are more skilled players than line position.
...
```
this t-test shows that it is a difference in the ability of the position to perform more pushups in 2 minutes.
...
The T-test to compare mean, has a p-value of 0.000009421
this is less than 0.05, therefore we reject the null hypothesis, and conclude that we have evidence that there is a difference in the average number of pushups that can be done in 2 minutes by line and skill players.
